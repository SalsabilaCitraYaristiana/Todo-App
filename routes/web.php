...
Route::middleware('isLogin')->group (function () {
    ...
    // path dinamis ini nantinya akan berubah-ubah tergantung data yang diberikan, 
    // apabila dalam route nya ada path dinamis maka nantinya data path dinamis ini dapat diakses oleh controller melalui parameter di function nya
