...
{{--menampilkan alert ketika validasi menghasilkan error--}}
    ...
    @endif
{{--mengirim data ke controller yg ditampung oleh Reques $request --}}
    @csrf
    ...
    <div class="d-flex flex-column">
        ...
        {{--kenapa textarea gapunya atribute value? karena textarea bukan termasuk tag input/select dan dia punya penutup tag, jadi buat nampilinnya langsung tanpa attribute value (sebelum penutup text area)--}}
    <textarea name="description" cols="30" rows="10">{{$todo['description']}}
    </textarea>
    </div>
